...
1. Write a function that uses [boto3's SageMaker client](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sagemaker.html) to appove a model registered as `PendingManualApproval`.
...
### Chapter 10 - Deploying From the Pipeline
...
### Chapter 11 - Deploying From an Event
